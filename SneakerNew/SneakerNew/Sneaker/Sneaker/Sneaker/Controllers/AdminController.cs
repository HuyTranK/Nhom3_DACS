...
namespace Sneaker.Controllers
{
    public class AdminController : Controller
    {
        ...
        // Constructor that accepts DataYikesDataContext through dependency injection
        public AdminController(DataYikesDataContext context)
        {
            dbcontext = context;
        }
        // GET: Admin
        ...
        public ActionResult Login(FormCollection collection)
        {
            ...
            {
                var ad = dbcontext.Addmins.Any(n => n.UserAdmin == tendn && n.PassAdmin == matkhau);
                if (ad)
                {
