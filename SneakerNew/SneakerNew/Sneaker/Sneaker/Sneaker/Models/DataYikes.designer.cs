...
namespace Sneaker.Models
{
    ...
    partial void InsertAddmin(Addmin instance);
    partial void UpdateAddmin(Addmin instance);
    partial void DeleteAddmin(Addmin instance);
    ...
    partial void DeleteThuongHieu(ThuongHieu instance);
		...
		public DataYikesDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["DbYikesConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Addmin> Addmins
		{
			get
			{
				return this.GetTable<Addmin>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Addmins")]
	public partial class Addmin : INotifyPropertyChanging, INotifyPropertyChanged
	{
